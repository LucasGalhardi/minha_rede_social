...
from minha_rede_social.users.models import User
from minha_rede_social.users.tests.factories import UserFactory
from minha_rede_social.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
